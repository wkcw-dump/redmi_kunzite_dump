...
cat vendor_boot/dtb/12_dtbdump_Qualcomm_Technologies,_Inc._RavelinP_SoC.dtb.* 2>/dev/null >> vendor_boot/dtb/12_dtbdump_Qualcomm_Technologies,_Inc._RavelinP_SoC.dtb
rm -f vendor_boot/dtb/12_dtbdump_Qualcomm_Technologies,_Inc._RavelinP_SoC.dtb.* 2>/dev/null
...
cat mi_ext/product/priv-app/MIUIVideoPlayer/MIUIVideoPlayer.apk.* 2>/dev/null >> mi_ext/product/priv-app/MIUIVideoPlayer/MIUIVideoPlayer.apk
rm -f mi_ext/product/priv-app/MIUIVideoPlayer/MIUIVideoPlayer.apk.* 2>/dev/null
